    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @endauth
                    <div class="ml-4 mt-2 z-50 relative">
                        ...
                        <div id="notificationDropdown" class="absolute top-6 mt-3 right-0 left-auto w-56 bg-white border border-gray-200 rounded-md shadow-lg origin-top-left divide-y divide-gray-100 ring-1 ring-black ring-opacity-5 focus:outline-none hidden" role="menu" aria-orientation="vertical" aria-labelledby="notifications-menu">
                            <!-- Notification Items -->
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">📌 Bookmark Alert: Save your progress in "Understanding Paul's Letters."</a>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">🎓 Earn a Certificate: Complete "Biblical Interpretation" for your certificate.</a>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">🤔 Question: What lesson from David and Goliath? Share in the forum!</a>
                        </div>
                    </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        notificationButton.addEventListener('click', function (event) {
            event.stopPropagation(); // Prevent event propagation to the document body
    ...
    document.addEventListener('click', function(event) {
        ...
        // Check if the clicked element is the notification button or inside the notification dropdown
        var isClickInsideDropdown = notificationDropdown.contains(targetElement);
        var isClickOnButton = (targetElement === notificationButton);

        // If the clicked element is outside the dropdown and not the notification button, close the dropdown
